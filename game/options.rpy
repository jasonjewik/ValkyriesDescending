...
define config.name = _("Valkyries Descending")
...
define build.name = "ValkyriesDescending"
...
define config.main_menu_music = "sounds/music/menu.mp3"
...
define config.save_directory = "ValkyriesDescending-1542835664"
